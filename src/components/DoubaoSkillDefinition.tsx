...
3. 【3:4 封面设计与标题（自动截图 · 垫图真人写实风格 · 还原截图表情不用夸张 · 标题不限字数空白处排布）】：
   - 【全流程自动化截图垫图】：系统在抽取视频帧时已全自动完成高潮截帧，直接以该截图作为底图垫图，真人写实画风；
   - 【还原截图表情，不用夸张】：严格 1:1 还原截图中人物的真实面孔、五官神态与衣着细节，面部表情不用刻意夸张，完全还原截图本身的真实生活微表情，严禁凭空生成假人假表情；
   - 【封面标题不限制字数 · 尽量写在空白处避让人脸】：
     * 封面标题不要去限制它多少字，依剧情冲突或关键动作自然提炼精炼抓人的全中文标题；
     * 若视频有口播/对白：提炼最具冲突张力的台词金句（如“真敢硬刚？”“这单我不接！”“卡尺不认人！”）；
     * 若视频无口播/无对白：根据纯画面动作交互提炼（如“反手递尺！”“一杠救命！”“当场破防！”）；
     * 【排版位置核心原则】：尽量写在空白处，不在他的人脸就行！严禁遮挡面部五官表情与眼睛；
   - 【敏感冲突转 3D 仿真人避险】：若画面涉及打斗冲突、血腥或暴力违禁内容，可通过以图生图转为【3D仿真人（类似Pixar 3D高质感CG）】进行降敏防封！
   - 调用豆包以图生图/免费生图生成 3:4 比例超清海报！
...
### 任务三：3:4 封面设计与标题方案（自动截图 · 垫图真人写实风格 · 还原截图表情不用夸张）
- 【全流程自动化垫图】：系统在抽取视频帧时已全自动抓取高潮截帧作为封面垫图，底图完全由系统自动生成并垫入；
- 【真人写实风格 · 还原截图表情不用夸张】：
  * 采用真人写实画风，严禁随意捏造无关假人/网红脸！严格 1:1 还原截图中人物的真实面孔、五官神态与朴素穿着；
  * 面部表情不用刻意夸张，完全还原截图本身的原始真实生活微表情与下意识神态；
  * 调用豆包免费生图时，必须采用【垫图/图生图 1:1 模式】，以该自动截帧为底图垫图，锁死真实人物身份与自然神态；
- 【封面标题智能提炼（不限制字数 · 依实况自然精炼表达）】：
  ...
  * 无论哪种，封面标题均不设置字数死板限制，字号由系统自适应缩放；
- 【标题排版核心原则：尽量写在空白处，不在他的人脸就行】：
  * 必须根据截帧中的人物面部位置与肢体动作分布决定标题排布，严禁遮挡人脸：
    - 若人物面孔/核心动作在画面中下方，上方留白：标题置于【顶部留白位 (top)】；
    - 若人物面部大特写或站立偏高（上半部分）：标题必须沉底置于【底部沉底位 (bottom)】，绝对严禁遮挡人物面部表情与眼睛！
    - 若画面上下有道具或环境、视线在中间：标题置于【中上/居中留白位 (middle)】；
- 【敏感冲突转 3D 仿真人避险】：
