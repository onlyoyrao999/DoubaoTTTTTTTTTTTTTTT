...
3. 【3:4 封面设计与短标题（核心重点）】：
   - 核心来源：主要以读取视频内容，截取一张最适合做封面的高潮分镜图片进行文字封面设计加工！
   - 提炼一个 4-8 字极具震撼力的全中文短标题（如“当场破防！”“直接撕破脸！”“他真下死手！”），强制嵌入画面顶部黄金位置；
   - 【暴力/敏感/乱七八糟内容降敏】：如果视频内容含有什么暴力、激烈冲突、打斗乱打等画面，就以【3D卡通仿真人形式（类似Pixar 3D仿真人高质感CG，避免真人血腥暴力审查）】进行封面生成！
   - 请直接调用你（豆包）自带的免费生图额度，生成一张 3:4 比例极具冲击力的封面，并强制在画面上方黄金位置嵌入这行中文短标题！
...
### 任务三：3:4 封面设计与短标题方案（视频截帧文字设计 / 3D仿真人降敏）
- 核心来源：主要以读取视频内容，截取一张最适合做封面的高潮分镜图片进行文字封面设计加工！
- 强制提取并嵌入【全中文短标题】（4-8个汉字），具有震撼性视觉冲击力（如：“当场破防！”“直接撕破脸！”“他真下死手！”），强制排在 3:4 竖版画面顶部居中黄金位置。
