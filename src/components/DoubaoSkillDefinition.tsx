...
- 【暴力冲突/杂乱内容降敏红线】：若视频内容含有什么暴力、冲突撕扯、激烈打斗或血腥等可能触发平台违规的内容，封面形式必须自动转为【3D卡通仿真人形式（类似高品质3D动画电影CG，人物真实还原生活神情但材质为仿真人CG）】进行生成，规避真实暴力违规审查！
- 若无暴力敏感内容，则默认以视频真实截帧配合真实写实人物电影级排版（面部表情不用夸张，注重还原很原始的真实表情）。
