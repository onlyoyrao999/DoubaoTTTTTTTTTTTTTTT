...
3. 【3:4 封面设计与标题（双层主副标题：大字主标题 + 小字副标题 · 自动截取图必须用于垫图重新生成）】：
   - 【自动截取的图必须用于垫图重新生成】：严禁脱离截图直接纯文生图！系统在抽取视频帧时已全自动抓取高潮截帧，【该自动截取的图必须用于垫图底图，以图生图重新生成 3:4 真人写实电影级封面】；
   - 【双层主副标题架构】：
     * 【主标题（醒目大字）】：提炼极具视觉冲击力的核心爆点短语（如“当场破防！”、“反手递尺！”、“这单我不接！”、“一杠救命！”、“饭碗砸了？”）；
     * 【副标题（说明小字）】：紧跟剧情或反转补充说明（如“30年老钳工突袭测试 · 机械臂3秒精准复测”），双层排版层次分明；
   - 【还原截图表情，不用刻意夸张】：严格 1:1 还原截图中人物的真实面孔、五官神态与衣着细节，面部表情不用刻意夸张，完全还原截图本身的原始真实生活微表情，严禁凭空生成假人假表情；
   - 【封面标题不限制字数 · 尽量写在空白处避让人脸】：
     * 封面标题不要去限制它多少字，依剧情冲突或关键动作自然提炼精炼抓人的全中文大字主标题与小字副标题；
...
### 任务三：3:4 封面设计与标题方案（核心铁律：自动截取的图必须用于垫图重新生成）
