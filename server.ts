...
3. 3:4 冲击力《真人写实封面》方案（Cover）：
   ...
   - 【封面标题与排版设计：全面参考抖音百万美工设计体系，我们完全不插手、不设限，AI自主创意排版】：
     1) 【参考抖音百万美工设计体系】：让豆包/AI深度参考抖音全网十万赞/百万赞热门爆款视频的顶级美工封面设计与排版法则（涵盖百万美工的冲击力字体排布、字号反差、对比度配色、爆点主标题、双大字对比、侧边标、底部解说条、画面留白避障等）。我们完全不插手、不设死板限制，由 AI 自主根据本视频剧情与画面构图设计最具视觉张力和高点击率的封面排版；
     2) 【主标题（shortTitle）】：参考抖音百万美工封面爆点字效（如“当场破防！”、“反手递尺！”、“这单我不接了！”、“一杠救命！”、“饭碗砸了？”、“真敢硬刚？”），粗大醒目，形成第一眼视觉压迫感。主标题大字完全不设限，交由百万美工自主裁决；
     3) 【副标题（subtitle）】：紧跟核心剧情或戏剧反转的补充说明/疑问句子（如“30年老钳工突袭测试 · 机械臂3秒精准复测”、“暴雨无人车失控打滑 · 卖菜大叔舍身顶轮”）。【副标题不限制必须是小字，也可以是大字/双行大字；也不限制必须在底部，位置完全自由】，由百万美工根据画面留白与视觉平衡自主决定排在最底部、紧随主标、画面下方留白或居中侧边；
     4) 【主副标题字号与位置完全不设限制】：无论是大字还是小字、顶部底部居中还是并列，均不设字数、字号、位置与修辞的死板限制，全部由百万美工依视频剧情与画面构图自由创作发挥，核心原则只有一个：尽量写在空白处，绝不遮挡人物人脸与关键动作；
   ...
   - 【标题排版核心原则：尽量写在空白处，不在他的人脸就行】：
     封面主副标题的位置完全由百万美工根据截帧的【人物面部位置、肢体动作与留白分布】自主决定最佳排布，避开人脸与关键动作：
     * 可置于【顶部 (top)】、【中上 (upper_middle)】、【正中 (middle)】、【底部/中下部 (bottom)】等任意黄金视觉点；
