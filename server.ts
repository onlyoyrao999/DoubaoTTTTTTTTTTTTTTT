...
3. 3:4 冲击力《真人写实封面》方案（Cover）：
   ...
   - 【封面标题双层排版架构：主标题大字 + 副标题小字（不限制字数 · 尽量写在空白处，绝不遮挡人脸）】：
     1) 【主标题大字（shortTitle）】：极具视觉冲击力的核心爆点短语/词（如“当场破防！”、“反手递尺！”、“这单我不接了！”、“一杠救命！”、“饭碗砸了？”），字体粗大醒目；
     2) 【副标题小字（subtitle）】：紧跟核心剧情或戏剧反转的补充说明/疑问小字（如“30年老钳工突袭测试 · 机械臂3秒精准复测”、“暴雨无人车失控打滑 · 卖菜大叔舍身顶轮”、“20年掌勺被芯片取代 · 蹲在后门点烟出神”），以较小字号配合主标题形成层次分明的双层排版；
     3) 【不要去限制字数】：依视频剧情或动作自然提炼精炼抓人的全中文大字主标题与小字副标题，不设死板字数限制，字号由系统自适应缩放；
     4) 【若视频有口播/对白内容】：主标题优先捕捉最具有杀伤力、最反转的一句核心台词或口播金句爆点，副标题补充情节背景；
     5) 【若视频没有口播/无对白（如纯现场音、纯BGM、实况录屏或无声）】：严格根据纯画面视觉动作与道具交互提炼主副标题；
     6) 明确标注提炼来源属性（titleSource: 'voiceover' | 'visual_action'）；
