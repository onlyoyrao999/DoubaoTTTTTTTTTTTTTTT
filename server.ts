...
3. 3:4 冲击力《真人写实封面》方案（Cover）：
   ...
   - 【封面标题与排版设计：全面参考抖音百万美工设计体系，我们完全不插手、不设限，AI自主创意排版】：
     1) 【参考抖音百万美工设计体系】：让豆包/AI深度参考抖音全网十万赞/百万赞热门爆款视频的顶级美工封面设计与排版法则（涵盖百万美工的冲击力字体排布、字号反差、对比度配色、爆点主标题、封面底部电影级解说条、画面留白避障等）。我们完全不插手、不设死板限制，由 AI 自主根据本视频剧情与画面构图设计最具视觉张力和高点击率的封面排版；
     2) 【主标题大字（shortTitle）】：参考抖音百万美工封面爆点字效（如“当场破防！”、“反手递尺！”、“这单我不接了！”、“一杠救命！”、“饭碗砸了？”、“真敢硬刚？”），字体粗大醒目，排在上方留白处；
     3) 【副标题小字（subtitle）】：紧跟核心剧情或戏剧反转的补充说明/疑问小字（如“30年老钳工突袭测试 · 机械臂3秒精准复测”、“暴雨无人车失控打滑 · 卖菜大叔舍身顶轮”、“20年掌勺被芯片取代 · 蹲在后门点烟出神”），排在【封面最底部】解说条，绝不在大标题底部，主副分离不挡脸；
     4) 【排版与字数完全不设限】：依视频剧情或动作自然提炼精炼抓人的全中文大字主标题与小字副标题，由百万美工网感自主决定排版细节与字体层次；
     5) 【若视频有口播/对白内容】：主标题优先捕捉最具有杀伤力、最反转的一句核心台词或口播金句爆点，副标题补充情节背景；
     6) 【若视频没有口播/无对白（如纯现场音、纯BGM、实况录屏或无声）】：严格根据纯画面视觉动作与道具交互提炼主副标题；
     7) 明确标注提炼来源属性（titleSource: 'voiceover' | 'visual_action'）；
   - 【标题排版核心原则：尽量写在空白处，不在他的人脸就行】：
     封面主副标题的位置绝非千篇一律固定在顶部，必须根据所选截帧的【人物面部位置、肢体动作与留白分布】智能决定：
     * 【顶部 (top)】：当人物主体/面孔或动作集中在画面中下方，上方有大片空间留白时，主副标题放顶部留白处，避开人物面部与动作；
     * 【底部 (bottom)】：当画面为人物面部大特写、人物站立偏高、或核心动作冲突发生在上半部分时，主副标题必须沉底置于画面下方空白处，【绝对严禁遮挡人物的眼睛、面部表情或核心道具】！
     * 【中上/居中 (upper_middle / middle)】：当画面构图为上下两极分布，中间有自然视觉空白时，主副标题可置于中上或居中空白处形成视觉撞击点；
          ...
          properties: {
            ...
            coverDesign: {
              ...
              properties: {
                shortTitle: {
                  type: Type.STRING,
                  description: '全中文极具冲击力的封面主标题大字（如“当场破防！”、“反手递尺！”、“这单我不接了！”，排版尽量写在空白处，避开人脸）',
                },
                subtitle: {
                  type: Type.STRING,
                  description: '全中文封面副标题小字（补充说明/悬念小字，如“30年老钳工突袭测试 · 机械臂3秒精准复测”，排版在主标题旁）',
                },
                characterExpression: {
                  type: Type.STRING,
